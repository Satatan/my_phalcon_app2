...
class ControllerBase extends Controller{
  ...
  public function initialize() { // function ที่จะถูกเรียนใช้งานก่อนทุกครั้ง ที่เริ่มระบบ
    ...
    $this->assets
      ...
      ->addCss('https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,700,300italic,400italic,700italic')
      ->addCss('public/vendor/simple-line-icons/css/simple-line-icons.css')
